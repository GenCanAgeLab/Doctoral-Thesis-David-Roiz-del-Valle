...
gse <- readRDS("data/R_data/liver_gse.rds")
...
saveRDS(gene_vsd, file = "data/R_data/liver_vsd.rds")
saveRDS(shrinkedRes, file = "data/R_data/liver_dds_shrinked.rds")
saveRDS(gene_res, file = "data/R_data/liver_results.rds")
